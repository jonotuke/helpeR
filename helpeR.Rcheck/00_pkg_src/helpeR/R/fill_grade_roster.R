...
#' @return nothing
#' @export
fill_grade_roster  <- function(df, infile, RAA = 45:49){
  ...
  # data
  data  <- readr::read_csv(csv_infile, skip = i-1,
                           show_col_types = FALSE)
  # Get IDs
  IDs  <- df |> dplyr::pull(student_id)
...
# data("gradebook")
# gradebook <- gradebook |>
#   mutate(total = myuni_total)
# fill_grade_roster(gradebook, "data-raw/STATS 4013_4410_FIN.xlsx")
